...
_SHELL_SANDBOX_KEEPALIVE_TARGET_CEILING="${SANDBOX_KEEPALIVE_TARGET_CEILING:-}"
_SHELL_SANDBOX_KEEPALIVE_RECONCILE_RESERVE="${SANDBOX_KEEPALIVE_RECONCILE_RESERVE:-}"
_SHELL_SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC="${SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC:-}"
_SHELL_HANDS_CHILD_UID_MIN="${HANDS_CHILD_UID_MIN:-}"
_SHELL_HANDS_CHILD_UID_MAX="${HANDS_CHILD_UID_MAX:-}"
_SHELL_HANDS_CHILD_ISOLATION="${HANDS_CHILD_ISOLATION:-}"
SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC="${SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC:-}"
...
[ -z "${SANDBOX_KEEPALIVE_TARGET_CEILING:-}" ]  && SANDBOX_KEEPALIVE_TARGET_CEILING="$_SHELL_SANDBOX_KEEPALIVE_TARGET_CEILING"
[ -z "${SANDBOX_KEEPALIVE_RECONCILE_RESERVE:-}" ] && SANDBOX_KEEPALIVE_RECONCILE_RESERVE="$_SHELL_SANDBOX_KEEPALIVE_RECONCILE_RESERVE"
[ -z "${SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC:-}" ] && SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC="$_SHELL_SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC"
[ -z "${HANDS_CHILD_UID_MIN:-}" ] && HANDS_CHILD_UID_MIN="$_SHELL_HANDS_CHILD_UID_MIN"
[ -z "${HANDS_CHILD_UID_MAX:-}" ] && HANDS_CHILD_UID_MAX="$_SHELL_HANDS_CHILD_UID_MAX"
[ -z "${HANDS_CHILD_ISOLATION:-}" ] && HANDS_CHILD_ISOLATION="$_SHELL_HANDS_CHILD_ISOLATION"
...
if [ "${DRY_RUN:-false}" != "true" ]; then
  for _lifetime_key in AGENT_SANDBOX_SESSION_TIMEOUT AGENT_SANDBOX_MAX_SESSION_DURATION \
                       ...
                       HANDS_CHILD_UID_MIN HANDS_CHILD_UID_MAX HANDS_CHILD_ISOLATION; do
...
unset _SHELL_DOMAIN _SHELL_AUTH_INTERNAL_TOKEN _SHELL_S3_ENDPOINT \
      ...
      _SHELL_SANDBOX_KEEPALIVE_TARGET_CEILING _SHELL_SANDBOX_KEEPALIVE_RECONCILE_RESERVE \
      _SHELL_SANDBOX_KEEPALIVE_IDLE_DEADLINE_SEC \
      _SHELL_HANDS_CHILD_UID_MIN _SHELL_HANDS_CHILD_UID_MAX _SHELL_HANDS_CHILD_ISOLATION
